...
const main21426 = async() => {
   // await createSpecimen("SERUM", "serum-test");

    // const arrKits = await getArrayWithTubes('50ML_EPPENDORF_CONICAL_TUBE', 'BALTIMORE_AVAILABLE_CONTAINERS', 3); //?
    const arrKits = await getArrayWithTubes('50ML_EPPENDORF_CONICAL_TUBE', 'CAMBRIDGE_AVAILABLE_CONTAINERS', 3); //?

    await arrKits.forEach(function (item, index) {
            putAnySpecimenInTube(item, 300, "serum-test");
