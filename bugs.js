...
// import {putPlasmaInTube} from "./functions-dev";
...
const bugs = async () => {
    ...
    // const a = await getArrayWithTubes('PLATE_96', 'BALTIMORE_AVAILABLE_CONTAINERS', 1);
    // const b = await getArrayWithTubes('PLATE_96', 'BALTIMORE_AVAILABLE_CONTAINERS', 1);
    //
    await putAnySpecimenInTube(arr[0], 500, 'pl_test');
    await queueUpload(arr[0],'GENERIC_CFDNA_EXTRACTION_QUEUE')
console.log(arr);
